...
/* DispatcherServlet은 웹 요청을 받ㄷ는 즉시 @Controller가 달린 컨트롤러 클래스에 처리를 위임한다.
...
public class MethodMappingTestController {
    ...
    public String registMenu(Model model) {
        ...
        /* Model 객체에 addAttribute 메소드를 이용해 key, value를 추가하면 추후 view에서 사용할 수 있다.
        * 추후 chap03-view-resolver에서 다시 다룬다. */
        ...
        * 추후 chap03-view-resolver에서 다시 다룬다. */
        ...
        //mappingResutl.html에 작성된 내용이 리턴된다.

    }

    /* 2. 메소드 방식 지정 */
    /* 요청 url을 value 속성을 요청 method를 method 속성이 설정 */
