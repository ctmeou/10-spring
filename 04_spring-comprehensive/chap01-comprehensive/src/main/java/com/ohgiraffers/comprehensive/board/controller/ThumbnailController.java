...
public class ThumbnailController {
    ...
    public String registThumbnail(BoardDTO board, List<MultipartFile> attachImage,
        ...
        log.info("thumbnail attachImage : {}", attachImage);
        ...
        try {
            ...
            for (int i=0; i< attachImage.size(); i++) {
                ...
                if (attachImage.get(i).getSize() > 0) {
                    ...
                    //파일명 rename
                    String oringinFileName = attachImage.get(i).getOriginalFilename();
                    log.info("originalFileName : {}", oringinFileName);

                    String ext = oringinFileName.substring(oringinFileName.lastIndexOf("."));
                    ...
                    fileInfo.setOriginalName(oringinFileName);
    ...
    @GetMapping("/detail")                  //화면에 보여줄 view 생성 위해 Model 담음
